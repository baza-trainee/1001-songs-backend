...
<p>Ви отримали цього листа, тому що зробили запит на відновлення паролю для вашого облікового запису на сайті 1000 and 1 Songs.</p>

<p>Для відновлення паролю, будь ласка, натисніть на кнопку нижче:</p>

<a class="recovery-button" href="%s/admin/forgot-password/reset?token=%s" target="_blank">
  <b>відновити пароль</b>
</a>

<p>Якщо ви не робили запит на відновлення паролю, просто проігноруйте це повідомлення.</p>

<p>З повагою,<br>Команда 1000 and 1 Songs.</p>
